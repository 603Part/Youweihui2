...
public class TailOrderTabRecycleAdapter extends RecyclerView.Adapter<TailOrderTabRecycleAdapter.viewHolder> {

    private List<HomeTailOrderEntity> list;

    private Context context;

    public TailOrderTabRecycleAdapter(List<HomeTailOrderEntity> list) {
        this.list = list;
    }
