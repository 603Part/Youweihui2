...
public class ShopTravelListAdapter extends RecyclerView.Adapter<ShopTravelListAdapter.ViewHolder> {
    ...
    public ShopTravelListAdapter(Context mContext, List<FindRecommendGoodsBean.TravellistBean> listBeans) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(inflater.inflate(R.layout.item_top_shop, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull ShopTravelListAdapter.ViewHolder holder, int position) {
