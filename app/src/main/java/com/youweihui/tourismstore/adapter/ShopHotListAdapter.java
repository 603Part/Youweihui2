...
public class ShopHotListAdapter extends RecyclerView.Adapter<ShopHotListAdapter.ViewHolder> {
    ...
    public ShopHotListAdapter(Context mContext, List<FindRecommendGoodsBean.HotlistBean> listBeans) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ShopHotListAdapter.ViewHolder holder, int position) {
