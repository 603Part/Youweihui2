...
public class ClassifyRightAdapter extends RecyclerView.Adapter<ClassifyRightAdapter.viewHolder> {
    ...
    private List<ClassifyRightEntity> list;

    private Context context;

    private int selectPos = 0;

    public ClassifyRightAdapter(List<ClassifyRightEntity> list) {
        this.list = list;
    }
    ...
    public viewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new viewHolder(LayoutInflater.from(context).inflate(R.layout.item_classify_right, parent, false));
    }
...
//        }
        ...
        holder.imageView.setSelected(list.get(position).isCheck());
    ...
    class viewHolder extends RecyclerView.ViewHolder {
        ...
        public viewHolder(View itemView) {
            ...
            textView1 = (TextView) itemView.findViewById(R.id.item_classify_right_text);
...
//            textView3 = (TextView) itemView.findViewById(R.id.);
    ...
    public void setData(List<ClassifyRightEntity> list) {
        this.list = list;
    ...
    public List<ClassifyRightEntity> getData() {
        return list;
    }
}
