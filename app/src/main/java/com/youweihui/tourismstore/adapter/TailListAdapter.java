...
public class TailListAdapter extends RecyclerView.Adapter<TailListAdapter.viewHolder> {

    private List<HomeTailOrderEntity> list;

    private Context context;

    public TailListAdapter(List<HomeTailOrderEntity> list) {
        this.list = list;
    }
    ...
    public viewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new viewHolder(LayoutInflater.from(context).inflate(R.layout.item_tail_list, parent, false));
    }
