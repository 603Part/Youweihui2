...
public class EndFragment1Adapter extends RecyclerView.Adapter<EndFragment1Adapter.viewHolder> {

    private List<EndFragment1Entity> list;

    private Context context;

    public EndFragment1Adapter(List<EndFragment1Entity> list) {
        this.list = list;
    }
    ...
    public viewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new viewHolder(LayoutInflater.from(context).inflate(R.layout.item_end_frag1, parent, false));
    }
