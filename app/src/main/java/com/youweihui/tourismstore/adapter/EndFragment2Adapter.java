...
public class EndFragment2Adapter extends RecyclerView.Adapter<EndFragment2Adapter.viewHolder> {

    private List<ForumEntity> list;

    private Context context;

    public EndFragment2Adapter(List<ForumEntity> list) {
        this.list = list;
    }
    ...
    public viewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new viewHolder(LayoutInflater.from(context).inflate(R.layout.item_end_frag2, parent, false));
    }
    ...
    class viewHolder extends RecyclerView.ViewHolder {
        ...
        public viewHolder(View itemView) {
            super(itemView);
            imageView = (ImageView) itemView.findViewById(R.id.item_end_frag2_img);
            textView1 = (TextView) itemView.findViewById(R.id.item_end_frag2_name);
            textView2 = (TextView) itemView.findViewById(R.id.item_forum2_time);
            textView3 = (TextView) itemView.findViewById(R.id.item_end_frag2_content);
