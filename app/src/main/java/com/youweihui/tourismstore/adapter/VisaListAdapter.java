...
public class VisaListAdapter extends RecyclerView.Adapter<VisaListAdapter.viewHolder> {

    private List<VisaListEntity> list;

    private Context context;

    public VisaListAdapter(List<VisaListEntity> list) {
        this.list = list;
    }
    ...
    public viewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new viewHolder(LayoutInflater.from(context).inflate(R.layout.item_visa_list, parent, false));
    }
...
//            textView3 = (TextView) itemView.findViewById(R.id.);
    ...
    public void setData(List<VisaListEntity> list){
        this.list = list;
